...
const Offer = () => {
  return (
    <section className='section' id="offer">
      ...
      <div class="w-auto my-24 lg:mb-16 text-center items-center justify-center">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Oferta</h2>
          <p class="text-gray-500 text-[30px] dark:text-gray-400">W czym możemy ci pomóc?</p>
      </div>
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Obsługa informatyczna firm i instytucji</h3>
              <p class="text-gray-500 dark:text-gray-400">Nasza kadra składa się z doświadczonych ekspertów, którzy posiadają wiedzę i umiejętności niezbędne do rozwiązywania wszelkich problemów związanych z technologią informatyczną.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Sprzedaż sprzętu komputerowego</h3>
              <p class="text-gray-500 dark:text-gray-400">Jesteśmy również renomowanym dostawcą sprzętu komputerowego, oferując szeroki asortyment wysokiej jakości urządzeń i akcesoriów, które spełnią Twoje potrzeby technologiczne.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Naprawa i montaż komputerów</h3>
              <p class="text-gray-500 dark:text-gray-400">Nasza wysoko wykwalifikowana i doświadczona ekipa techniczna stawia sobie za cel naprawę i rozbudowę Twojego sprzętu, aby zapewnić mu optymalną wydajność i żywotność.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Budowa sieci komputerowych</h3>
              <p class="text-gray-500 dark:text-gray-400">Oferujemy kompleksowe usługi związane z projektowaniem, budową i utrzymaniem sieci, które są kluczowym elementem zapewnienia płynności działania Twojej firmy lub instytucji w erze cyfrowej.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Sprzedaż i doradztwo w zakresie oprogramowania komputerowego</h3>
              <p class="text-gray-500 dark:text-gray-400">Nasza wiedza i doświadczenie pozwalają nam dostarczać najlepsze rozwiązania oprogramowaniowe, które odpowiadają Twoim potrzebom i celom biznesowym.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Sprzedaż dedykowanych systemów oprogramowania</h3>
              <p class="text-gray-500 dark:text-gray-400">Nasza oferta obejmuje kompleksowe rozwiązania oprogramowaniowe, które pomagają usprawnić procesy biznesowe, zwiększyć wydajność i osiągnąć konkurencyjność na rynku.</p>
          </div>
      </div>
  </div>
    </section>
