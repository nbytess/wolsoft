                ...
                <div className="mobile-menu block md:hidden lg:hidden">
                    {
                        !headerOpen ? (
                            ...
                            <button onClick={() => setHeaderOpen(false)} className="flex items-center px-3 py-2 border rounded border-slate-200 text-slate-200 hover:text-white hover:border-white"><XmarkIcon className="h-5 w-5" /></button>
                        )
                    }
                </div>
